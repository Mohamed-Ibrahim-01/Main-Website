    ...
    return (
        <Grid container item justify="space-around" alignContent="center" style={{marginBottom:"20px"}}> 
            ...
            <Grid container direction="column" item md={10} sm={10} xs={9} justify="space-around" >
                <Grid item >
                    <Typography variant="h6" style={{fontFamily:"'Varela Round', sans-serif", color:"#2276e7"}}>{title}</Typography>
                </Grid>
                <Grid item >
                    <Typography variant="body1" style={{fontFamily:"'Varela Round', sans-serif", color:"#000c26"}}> {desc}</Typography> 
                </Grid>
            </Grid>
        </Grid>
    )
